...
describe User do
  ...
  describe "when email is invalid" do
    %w[user@foo,com, user#foo.com, user_at_foo.com, user@foo.].each do |email|
  ...
  describe "when email is valid" do
    %w[user@foo.com, user@foo.org, user@foo.com.cn, user@foo.cn].each do |email|
      before { @user.email = email }
      it { should be_valid }
    end
  end
  ...
  describe "accessible attributes" do
    it "should not allow access to admin" do
      expect do
        User.new(name: "Tyler Long", email: "tylerlong@example.com",
